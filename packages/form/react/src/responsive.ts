...
function responsiveOptionStyles<T extends string>(prefix: string, value: ResponsiveOption<T> | undefined, fallback: T): CSSProperties {
...
export function flexStyles(direction: ResponsiveOption<'row' | 'column'> | undefined, justify: ResponsiveOption<'start' | 'center' | 'end' | 'between' | 'around' | 'evenly'> | undefined, align: ResponsiveOption<'start' | 'center' | 'end' | 'stretch' | 'baseline'> | undefined): CSSProperties {
...
export function responsiveStyles(prefix: string, value: ResponsiveValue | ColumnSpanValue | null | undefined, fallback?: number): CSSProperties {
...
export function placementStyles(component: { columnSpan: ColumnSpanValue; columnStart?: ResponsiveValue | null; order?: ResponsiveValue | null }): CSSProperties {
  return {
